...
//
////////////////////////////////////////////////
// Allowed export formats are 'png' and 'svg'. The extension will be added, just summply the base filename.
// Saving to raster format is dependent on FileSaver.js and canvg.js (which include rgbcolor.js & StackBlur.js), they must be loaded before circularplot.js
genomeTrack.prototype.savePlot = function(scaling, filename, stylesheetfile, format) {
    ...
    var clonedSVG = document.getElementById(container).cloneNode(true);
    ...
    // Append the stylehsheet to the cloned svg element so when we export it the style are inline and  get rendered
    ...
    if(format == 'svg') {
        ...
        // Convert the canvas to a data url (this could be displayed inline by inserting it in to an  <img> tag in the src attribute, ie <img src="'+imgData+'">
